...
DatosC = np.loadtxt(r'D:\Grupo v3\1 ventana determinacion de Tc, 5v,250ms.csv', delimiter = ',')
t = DatosC[0][50:2000]
d = DatosC[1][50:2000]



autocorre = np.correlate(d,d,mode="same")
...
#paso = 0.001/250 # supongo que es el tiempo entre cada punto preguntar
paso = t[1]-t[0]
